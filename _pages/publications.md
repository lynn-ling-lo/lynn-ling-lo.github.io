...
<div style="display: flex; gap: 20px; margin-bottom: 30px; align-items: flex-start;">
  <div style="flex-shrink: 0;">
    <img src="../images/publication_images/ICCV2025.png" alt="Paper Thumbnail" style="width: 40%; border: 0px solid black; padding: 8px">
  </div>
  <div style="flex: 1;">
...
<div style="display: flex; gap: 20px; margin-bottom: 30px; align-items: flex-start;">
  <div style="flex-shrink: 0;">
    <img src="../images/publication_images/AAAI2025.png" alt="Paper Thumbnail" style="width: 40%; border: 0px solid black; padding: 8px">
  </div>
  <div style="flex: 1;">
